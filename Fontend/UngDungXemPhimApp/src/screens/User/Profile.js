...
export default function Profile({ navigation }) {
  ...
  // Hàm điều hướng đến trang lịch sử xem phim
  const navigateToWatchHistory = () => {
    navigation.navigate('WatchHistoryScreen');
  };

  // Hàm điều hướng đến trang thông tin tài khoản
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.menuList}>
        <TouchableOpacity style={styles.menuItem} onPress={navigateToWatchHistory}>
        ...
        <TouchableOpacity style={styles.menuItem} onPress={navigateToAccountInfo}>
          <Icon name="list" size={20} color="#ff4d6d" style={styles.menuIcon} />
          <Text style={styles.menuText}>Thông tin tài khoản</Text>
          <Icon name="chevron-right" size={18} color="#ff4d6d" style={styles.menuArrow} />
        </TouchableOpacity>
        <TouchableOpacity style={styles.menuItem} onPress={navigateToForgotPassword}>
